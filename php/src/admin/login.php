...
<body style="background-image: linear-gradient(6deg, var(--bs-primary-fade), transparent);">
    <div class="d-flex justify-content-center vh-100 align-items-center">
        <div class="d-flex align-items-center p-4 bg-white rounded-4" style="width: 400px;">
            <div class="w-100">
                <form id="login-form" method="post">
                    ...
                    <button type="submit" class="btn-primary btn w-100 rounded-4" style="height: 50px;">เข้าสู่ระบบ</button>
                </form>
