...
<div class="mt-4 p-2 overflow-y-auto overflow-x-hidden" style="height: calc(100% - 15%);">
    <div class="d-flex flex-column gap-2">
        <div class="d-flex">
            <div class="rounded-5 p-5 position-relative" style="width: 500px;background-color:#0085ff">
        ...
        <div class="d-flex">
            <div class="rounded-5 p-5 position-relative" style="width: 500px;background-color:#63ec8d">
                <div class="d-flex gap-4 align-items-center justify-content-start">
