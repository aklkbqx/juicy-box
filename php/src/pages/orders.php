...
if ($_SERVER["REQUEST_URI"] == "/pages/orders.php" || $_SERVER["REQUEST_URI"] == "/pages/orders.php?tabs=") {
    header("location: /pages/orders.php?tabs=all");
    exit;
}
    ...
    <div class="p-2">
        <div class="container " style="margin-top: 7rem;">
            <div class="d-flex justify-content-start">
                <a href="../" class="d-flex align-items-center text-primary gap-2">
                    <i class="fa-solid fa-left-long"></i>
                    <h5>กลับ</h5>
                </a>
            </div>
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <h4 class="d-flex align-items-center my-3 fw-semibold fs-1 text-primary">คำสั่งซื้อของฉัน <i class="fa-solid fa-list-check ms-2"></i></h4>
                ...
                <div class="d-flex justify-content-center mb-2">
                    <ul class="m-0 p-0 list-unstyled d-flex flex-row flex-wrap gap-2 justify-content-center">
                        ...
                        foreach ($ordersTabsName as $index => $tabname) { ?>
                            <a href="/pages/orders.php?tabs=<?= $tabname; ?>" class="text-decoration-none fs-5 fw-medium btn rounded-4 <?= isset($_GET["tabs"]) && $_GET["tabs"] == $tabname ? "text-white btn-primary" : "btn-light text-primary" ?>">
                                <li>
                                    <?php
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    <h5><?= $product["name"] ?></h5>
                                                    <h6 class="text-muted">ประเภทการชง: <?= $order["drink_type"] ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
