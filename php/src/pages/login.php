...
<body class="bg-light">
    ...
    <div class="position-absolute" style="transform: translate(-50%, -50%);top: 50%;left: 50%;">
        <div class="d-flex align-items-center py-5 justify-content-center">
            ...
            <!-- <img src="<?= pathImage("logo.png", "web")  ?>" alt="banner login" width="300px" height="auto" class="rounded-4 d-none d-md-block"> -->
            <div class="d-flex align-items-center p-4 h-100" style="width: 400px;">
                <div class="w-100">
                    <form id="login-form" method="post">
                        <h1 class="mb-2 text-center text-white">เข้าสู่ระบบ</h1>
